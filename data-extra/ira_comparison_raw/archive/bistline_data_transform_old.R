...
data.emissions <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "Emissions") %>%
  gather("year", "value", 4:11) %>%
  mutate(table = "emissions")

data.co2captured <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "CO2 Captured") %>%
  gather("year", "value", 4:9) %>%
  mutate(table = "co2_captured")

# data.costs <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "Costs") %>%
#   gather("year", "value", 4:9) %>%
#   mutate(table = "costs")

data.elecdemand <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "Electricity Demand") %>%
  gather("year", "value", 4:9) %>%
...
data.nox <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "NOx") %>%
  gather("year", "value", 4:9) %>%
  mutate(table = "nox")

# data.so2 <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "SO2") %>%
#   gather("year", "value", 4:9) %>%
#   mutate(table = "so2")

data.ffconsump <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "Fossil Fuel Consumption") %>%
...
data.transport <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "Transport") %>%
  mutate(unit = '%') %>%
...
generation <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "generation") %>%
...
capacity <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "capacity") %>%
...
capacity_change <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "capacity change") %>%
...
hist_generation <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "historic generation") %>%
...
hist_capacity_change <- read_xlsx("data-extra/ira_comparison_raw/ira_comparison_old.xlsx", sheet = "historic capacity change") %>%
