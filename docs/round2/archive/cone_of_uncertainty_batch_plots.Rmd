...
pdf(file="output/round1/cone_of_uncertainty_batch/cone_of_uncertainty.pdf", width = 12, height = 6)
...
for (i in 1:length(var_names)) {
  ...
  coneofuncertainty(emf_data_long, var_names[i], title_names[i], config$main_scenarios, config$models)
