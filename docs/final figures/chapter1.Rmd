...
```{r}
# Figure 1.1
subpalettes_temp = subpalettes # save off version to be used after this figure's temp subpalette
...
subpalettes = subpalettes_temp # change back to original subpalettes
```
