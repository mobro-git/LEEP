...
EconSpg = spg(
  ...
  c(0, 2000, 4000, 6000),
  scales::comma) +
  annotate("text", x = 2015, y = 4900, label = "Historical", color = "black") +
...
GasSpg = spg(
  ...
  c(0, 10, 20 , 30 , 40),
  NULL)+
  annotate("text", x = 2010, y = 35, label = "Historical", color = "black") +
...
p7 = sens_dot_plot(sens_dta_econ, title = "\nIRA Implementation", figmap_leep_timeseries, config, 
                   ymin = 0, ymax = 5000, far_left = TRUE, single = FALSE,
...
all_panels_gt %>% gtsave("test.html")
