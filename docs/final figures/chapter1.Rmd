...
indicator_small = function(filter_variable, bottom = FALSE) {
  data_small = indicators_all %>% filter(sector == filter_variable)
  summ_small = indicators_summ %>% filter(sector == filter_variable)
  p = data_small %>% 
    ggplot() +
      ...
      ggtitle(filter_variable) +
      scale_color_manual(values = c(subpalettes$`Economy-Wide Emissions`[['IRA']], 
                                    subpalettes$`Economy-Wide Emissions`[['No IRA']]), 
                         breaks = c("IRA", "No IRA")) +
      ...
      theme(axis.ticks = element_blank(), axis.text.y = element_blank(), 
            ...
            strip.text.y.left = element_text(size = 8, face = "plain", angle = 0),
            axis.text.x = element_text(face = "plain"),
            panel.grid.major.x = element_blank(),
            panel.grid.minor.x = element_blank(),
            panel.border = element_blank(),
            axis.line.x = element_line(color = "#59+5959", linewidth = 0.25),
...
p1 = indicator_small("Economy-Wide")
p2 = indicator_small("Electricity")
p3 = indicator_small("Transportation")
p4 = indicator_small("Buildings")
p5 = indicator_small("Industry", bottom = TRUE)
...
all_panels_gt %>% 
  gtsave(paste0("./output/final_figures/display_tables/Table",fig_no,".html"))

all_panels_gt %>% 
  gtsave(paste0("./output/final_figures/display_tables/Table",fig_no,".png"))
