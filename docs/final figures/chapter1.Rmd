...
## F1.1 economy-wide co2 emissions from fossil fuel combustion by sector
...
ElecTab = html(Elec_data, "Electricity CO<sub>2<sub>")
...
TranTab = html(Tran_data, "Transportation CO<sub>2<sub>")
...
Ind_data = spg_clean(
  ...
  clean_data, 
  figmap_leep_timeseries)
IndTab = html(Ind_data, "Industry CO<sub>2<sub>")
...
Buil_data = spg_clean(
  ...
  clean_data, 
  figmap_leep_timeseries)
BuilTab = html(Buil_data, "Building CO<sub>2<sub>")
...
for (col_num in c(5,6,8,9,10,11,12)) {
