...
p4 = emis_stack(dta4, "Industrial CO2 Emissions", figmap_leep_stackbar, config) + 
  ...
  scale_color_manual(values = c("Other Sectors" = "#CECECE", "Industry: Indirect" = "#CECECE", "Industry: Direct" = "#CECECE")) +
...
# TODO: double-check ind process emissions
...
saveall(IndDot, IndSpg$data, fig_no)
