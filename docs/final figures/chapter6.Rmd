...
IRA <- clean_data %>%
  ...
  filter(!model %in% c("MARKAL-NETL","AEO.2023", "REGEN-EPRI", "OP-NEMS"))
# MARKAL non-co2 too low, regen doesnt report non-energy co2, op-nems doesnt report non-energy co2
