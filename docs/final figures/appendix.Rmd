...
fig = (NoIRAfigure |
  ...
  plot_layout(guides = "collect") +
  plot_annotation(caption = "Electricity Generation from Coal with CCS")
...
fig = (NoIRAfigure |
         IRAfigure) / (adfigure$figure | plot_spacer()) +
  plot_layout(guides = "collect") +
  plot_annotation(caption = "Electricity Generation from Gas with CCS")
...
pdfigure = ggplot() +
  ...
  figure = (NoIRAfigure | IRAfigure) / (adfigure | pdfigure) + 
    plot_layout(guides = "collect") +
    plot_annotation(caption = "Electricity Generation from Other")
