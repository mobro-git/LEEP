...
# Appendix D: Buildings sector modeling

## Emissions reudctions by end use type from scout modeling

```{r}
fig_no = "D.1.scout_results"
...
saveall(fin, data_sort, fig_no, ht = 9.5, wd = 7.5)
```

# Appendix F: Results by model
...
```{r}
fig_no = "F.14.CoalnoCCSGen" # w/o CCS
...
```{r}
fig_no = "F.15.GasNoCCSGen" # w/o CCS
...
```{r}
fig_no = "F.3.gascoal_capacityfactor"
...
# Appendix G: Electrification summary

## Electrification Figure

```{r}
fig_no = "G.1.electricity_share_final_energy"
...
saveWorkbook(per_share_wb, file = "output/final_figures/data/TableG.1.share.xlsx", overwrite = TRUE)
```

```{R}
# display table for appendix G1
fig_no = "G1.Electricity Share"
...
saveWorkbook(per_share_wb, file = "output/final_figures/data/TableG.2.difference.xlsx", overwrite = TRUE)
```

```{R}
# display table for appendix G2
fig_no = "G2 Electricity Difference"
tab_dta = all_per %>% 
  data.frame() %>%
...
# Appendix H: Direct and indirect emissions breakouts

## EconWide Direct/Indirect

```{r}
fig_no = "H.1.ew_projections_direct_indirect"
...
```{r}
fig_no = "H.2.trn_projections_direct_indirect"
...
```{r}
fig_no = "H.3.bld_projections_direct_indirect"
...
```{r}
fig_no = "H.4.ind_projections_direct_indirect"
...
# Appendix I: Trends in electricity generation

## with 2021

```{r}
fig_no = "I.1.gen_bytype"
...
```{r}
fig_no = "I.2.genbytype_differences"
...
# Appendix J: Input assumptions

## Natural gas price

```{r}
fig_no = "J.1.naturalgasprice"
...
```{r} 
fig_no = "J.2.capitalcosts_bat_ngcc_sol_wnd"
...
fig_no = "J.3.capitalcosts_coalgasCCS"
...
```{r}
fig_no = "K.1.summary_ranges_sensitivities"
...
## Appendinx L
Relationships between number of provisions modeled and emissions reductions
```{r}
