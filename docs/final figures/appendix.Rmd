...
p = print_graph("stacked_bar", config, clean_data15, figmap_leep_stackbar, 18, "United States",
  ...
  facet_grid(scenario ~ model, switch = "x") + 
...
p = dta_full %>% ggplot() +
  geom_bar(aes(x = year, y = diff, fill = variable_rename), 
           position="stack", stat="identity") + 
  scale_x_continuous(breaks = c(2030, 2035), labels = c("2030", "2035"), position = "top") + 
  scale_y_continuous(expand = c(0,0), limits = c(-3100,3100), labels = scales::comma, 
...
Econ = (EconDot | TranDot | BuilDot | IndDot)

savefig(Econ, fig_no, wd = 9, ht = 4)
...
DirTab = html(DirSpg$data, "Direct Transportation CO<sub>2<sub>")
...
IndDirTab = html(IndDirSpg$data, "Indirect Transportation CO<sub>2<sub>")
...
DirTab = html(DirSpg$data, "Direct Industry CO<sub>2<sub>")
...
IndDirTab = html(IndDirSpg$data, "Indirect Industry CO<sub>2<sub>")
...
title = "YY.Total Electricity Generation"
...
title = "YY.Low Emitting Electricity Generation"
...
title = "YY.High Emitting Electricity Generation"
...
title = "YY.Wind Electricity Generation"
...
title = "YY.Solar Electricity Generation"
...
title = "YY.Nuclear Electricity Generation"
...
title = "YY.CCS Electricity Generation"
...
title = "YY.Coal Electricity Generation"
...
title = "YY.Nautural Gas Electricity Generation"
...
title = "YY.Other Electricity Generation"
