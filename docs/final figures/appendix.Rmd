...
ts_df_data = ts_df %>%
  mutate(variable = "Emissions", 
         label = "Economy-Wide Direct Emissions",
         figure_num = fig_no) %>%
  ungroup() %>%
...
ts_df_data = ts_df %>%
  mutate(variable = "Emissions", 
         label = "Transportation Direct Emissions",
         figure_num = fig_no) %>%
  ungroup() %>%
  select(figure_num, model, scenario, variable, unit, label, year, value)
...
ts_df_data = ts_df %>%
  mutate(variable = "Emissions", 
         label = "Buildings Direct Emissions",
         figure_num = fig_no) %>%
  ungroup() %>%
  select(figure_num, model, scenario, variable, unit, label, year, value)
...
ts_df_data = ts_df %>%
  mutate(variable = "Emissions", 
         label = "Industry Direct Emissions",
         figure_num = fig_no) %>%
  ungroup() %>%
  select(figure_num, model, scenario, variable, unit, label, year, value)
...
ts_df_data = ts_df %>%
  mutate(variable = "Emissions", 
         label = "Economy-Wide Indirect Emissions",
         figure_num = fig_no) %>%
  ungroup() %>%
  select(figure_num, model, scenario, variable, unit, label, year, value)
...
ts_df_data = ts_df %>%
  mutate(variable = "Emissions", 
         label = "Transportation Indirect Emissions",
         figure_num = fig_no) %>%
  ungroup() %>%
  select(figure_num, model, scenario, variable, unit, label, year, value)
...
ts_df_data = ts_df %>%
  mutate(variable = "Emissions", 
         label = "Buildings Indirect Emissions",
         figure_num = fig_no) %>%
  ungroup() %>%
  select(figure_num, model, scenario, variable, unit, label, year, value)
...
ts_df_data = ts_df %>%
  mutate(variable = "Emissions", 
         label = "Industry Indirect Emissions",
         figure_num = fig_no) %>%
  ungroup() %>%
  select(figure_num, model, scenario, variable, unit, label, year, value)
