...
```{r}
fig_no = "F.20.gascoal_generation"
...
```{r}
fig_no = "F.22.gascoal_capacityfactor"
...
saveWorkbook(per_share_wb, file = "output/final_figures/data/FigG.1.share.xlsx", overwrite = TRUE)
```
...
saveWorkbook(per_share_wb, file = "output/final_figures/data/FigG.1.difference.xlsx", overwrite = TRUE)
```
