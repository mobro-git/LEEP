...
data$variable_rename <- factor(data$variable_rename, level = c("Other Sectors", "Petroleum", "Natural Gas", "Coal"))
...
fig = ggplot(data, aes(fill = variable_rename, y = value, alpha = alpha, x = year, color = variable_rename)) + 
  ...
  scale_color_manual(breaks = c( "Coal", "Natural Gas", "Petroleum", "Other Sectors"), 
                     values = c( "#603913", "#808285", "#af499b", "#DEDEDE")) +
  scale_fill_manual(breaks = c( "Coal", "Natural Gas", "Petroleum", "Other Sectors"), 
                     values = c( "#603913", "#808285", "#af499b", "#DEDEDE")) +
...
fig = print_graph("stacked_bar", config, clean_data10, figmap_leep_stackbar, 140, "United States", 
                  level_var = c("Other", "Renewables", "Nuclear", "Petroleum", "Natural Gas", "Coal")) +
  labs(y = expression("Electricity Generation (TWh)")) +
  scale_y_continuous(expand = c(0,0), limits = c(0,4500), labels = scales::comma) +
  scale_fill_manual(labels = c("Coal", "Natural Gas", "Petroleum", "Nuclear", "Renewables", "Other"),
                     breaks = c("Coal", "Natural Gas", "Petroleum", "Nuclear", "Renewables", "Other"),
...
saveall(p, dta_full, paste(fig_no,"wide",sep="_"), wd = 7, ht = 6)
...
# fig_no = "E.18.generation_by_model"
# savedata(data_summary, paste(fig_no, "summary_table"))
```
...
savefig(combined, fig_no, ht = 8, wd = 7)
savefig(combined, paste(fig_no,"wide",sep="_"))
...
## Options for 2.6
```{r}
fig_no = "2.6.power_sensitivities_COL"
# fig_no = "2.6.power_sensitivities_BW"
...
p1 = sens_dot_plot(sens_dta_panel1, title = "\nIRA Implementation", 
                   figmap_leep_timeseries, config, 
                   ps = TRUE, ymin = 0, ymax = 1200, far_left = TRUE, 
                   ira_coord = c(2029.9,975), low_coord = c(2028.7, 1190), 
                   high_coord = c(2030.2, 1040))
p1$plot = p1$plot +
  theme(axis.ticks = element_line(color = "black"),
          axis.ticks.length = unit(-0.15, "cm"))
# p1
p2 = sens_dot_plot(sens_dta_panel2, title = "\nEconomic Growth", figmap_leep_timeseries, config, ymin = 0, ymax = 1200,)
p2$plot = p2$plot +
  theme(axis.ticks.x = element_line(color = "black"),
        axis.ticks.y = element_blank(),
        axis.ticks.length = unit(-0.15, "cm"))
#p2
p3 = sens_dot_plot(sens_dta_panel3, title = "\nEnergy Price", figmap_leep_timeseries, config, ymin = 0, ymax = 1200,)
p3$plot = p3$plot +
  theme(axis.ticks.x = element_line(color = "black"),
        axis.ticks.y = element_blank(),
        axis.ticks.length = unit(-0.15, "cm"))
# p3
p4 = sens_dot_plot(sens_dta_panel4, title = "\nTechnology", figmap_leep_timeseries, config, ymin = 0, ymax = 1200,)
p4$plot = p4$plot +
  theme(axis.ticks.x = element_line(color = "black"),
        axis.ticks.y = element_blank(),
        axis.ticks.length = unit(-0.15, "cm"))
# p4
p5 = sens_dot_plot(sens_dta_panel5, title = "Combined Technology\n + Implementation", 
                   figmap_leep_timeseries, config, ymin = 0, ymax = 1200,)
p5$plot = p5$plot +
  theme(axis.ticks.x = element_line(color = "black"),
        axis.ticks.y = element_blank(),
        axis.ticks.length = unit(-0.15, "cm"))
...
p2$plot = p2$plot + 
  scale_shape_manual(breaks = c(0), values = c(1)) +
  scale_color_manual(breaks = c("Low", "Mod", "High"), values = c("#2a546c", "black", "#b72467"))
  # annotate("text", x = 2028.4, y = 1595, size = 2,
  #              label = "GCAM-PNNL", color = "#A1A1A1", alpha = 1, hjust = 0)
...
p4$plot = p4$plot + 
  scale_shape_manual(breaks = c(-0.9, 0, 0.9), values = c(1,2,0)) +
  scale_color_manual(breaks = c("All-Adv", "Mod", "Constr", "Cons Renew", "Adv Renew"), 
                     values = c("#f15a22", "black", "#876123", "#11897d", "gray"))
  # annotate("text", x = 2028.4, y = 1595, size = 2,
  #              label = "GCAM-PNNL (L)", color = "#A1A1A1", alpha = 1, hjust = 0) +
  # annotate("text", x = 2028.4, y = 1545, size = 2,
  #              label = "ReEDS-NREL (M)", color = "#A1A1A1", alpha = 1, hjust = 0) +
...
p5$plot = p5$plot + 
  scale_shape_manual(breaks = c(-0.6, 0.6), values = c(5,0)) +
  scale_color_manual(breaks = c("Pess-Adv", "Mod", "Opt-Adv"), values = c("#524fa1", "black", "#488C49"))
  # annotate("text", x = 2028.4, y = 1595, size = 2,
  #              label = "NEMS-OP (L)", color = "#A1A1A1", alpha = 1, hjust = 0) +
  #   annotate("text", x = 2028.4, y = 1545, size = 2,
  #              label = "USREP-ReEDS (R)", color = "#A1A1A1", alpha = 1, hjust = 0)
