...
dta5 = bind_rows(dta5, filler_row) %>%
  mutate(model = factor(model, levels = c("GCAM-PNNL", "RIO-REPEAT", "EPS-EI", "NEMS-RHG", "NEMS-OP", "GCAM-CGS", "ReEDS-NREL", "REGEN-EPRI", "Haiku-RFF", "IPM-EPA", "NEMS-EIA", "USREP-ReEDS", "IPM-NRDC", "MARKAL-NETL"
                                          ,"")))
