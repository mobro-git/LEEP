...
panel3_scens = c("Low Gas Price","High Gas Price", "Core", "IRA") # Energy Prices
...
panel5_scens = c("IRA.Low.Adv", "IRA.High.Adv", "Core", "IRA") # Combos
...
sens_dta_panel1 = sens_dta %>% filter(scenario %in% panel1_scens) %>%
  filter(model %in% c("EPS-EI", "GCAM-CGS","RIO-REPEAT","REGEN-EPRI","USREP-ReEDS", "ReEDS-NREL")) %>%
...
p1 = sens_dot_plot(sens_dta_panel1, title = "\nIRA Implementation", 
                   ...
                   ira_coord = c(2030,1020), low_coord = c(2028.7, 1200), 
                   high_coord = c(2030, 620))
# p1
p2 = sens_dot_plot(sens_dta_panel2, title = "\nEconomic Growth", ymin = 0, ymax = 1600,)
#p2
p3 = sens_dot_plot(sens_dta_panel3, title = "\nEnergy Price", ymin = 0, ymax = 1600,)
# p3
p4 = sens_dot_plot(sens_dta_panel4, title = "\nTechnology", ymin = 0, ymax = 1600,)
# p4
p5 = sens_dot_plot(sens_dta_panel5, title = "Combined Implementation \n + Technology", ymin = 0, ymax = 1600,)
# p5
...
p1$plot = p1$plot + 
  annotate("text", x = 2028.4, y = 1595, size = 3,
               label = "EPS-EI", color = "black", alpha = 1, hjust = 0) + 
  annotate("text", x = 2028.4, y = 1535, size = 3,
             label = "GCAM-CGS", color = "black", alpha = 1, hjust = 0) +
  annotate("text", x = 2028.4, y = 1475, size = 3,
             label = "ReEDS-NREL", color = "black", alpha = 1, hjust = 0) + 
  annotate("text", x = 2028.4, y = 1415, size = 3,
             label = "REGEN-EPRI", color = "black", alpha = 1, hjust = 0) + 
  annotate("text", x = 2028.4, y = 1355, size = 3,
             label = "RIO-REPEAT", color = "black", alpha = 1, hjust = 0) + 
  annotate("text", x = 2028.4, y = 1295, size = 3,
             label = "USREP-ReEDS", color = "black", alpha = 1, hjust = 0)

p2$plot = p2$plot + 
  annotate("text", x = 2028.4, y = 1595, size = 3,
               label = "GCAM-PNNL", color = "black", alpha = 1, hjust = 0)
...
# combine panels 4+5: "Technology"
# new panel title: "Combined Implementation + Technology"
# Add annotations to include model names 
# Add ReEDS core to left (and GCAM core)
# also do an arrows plot for EW and elec sector emissions
```
...
nox_full = dot_plots("time_series", config, clean_data7, figmap_leep_timeseries, 122, "United States", 0, 5, "Power Sector NOx Emissions", metric = "median", 
...
saveall(nox_full$full, dta1, fig_no)
```
...
sox_full = dot_plots("time_series", config, clean_data7, figmap_leep_timeseries, 123, "United States", 0, 5, "Power Sector SO2 Emissions", metric = "median", 
                     historic_coord = c(2019,2), preira_coord = c(2030, 1.2), ira_coord = c(2029, 0.12))
print(sox_full$full)
print(sox_full$stats)

dta2 = data_from_graph("time_series", config, clean_data7, figmap_leep_timeseries, 123, "United States")

saveall(sox_full$full, dta2, fig_no)
```

## 2.7A nox and sox in one figure
```{r}
fig_no= 2.7
