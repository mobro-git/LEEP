...
saveall(ElecDot,ElecSpg$data, paste(fig_no, "a"))

delta = delta(26, "", config, clean_data, figmap_leep_timeseries)
delta
saveall(delta$figure, delta$df, paste(fig_no, "b"), wd = 3.012, ht = 3)
...
savedata(data_summary, fig_no = "2.5 Summary Table")
savedata(data_summary, fig_no = "F.x2 Summary Table")
```
...
p1$plot = p1$plot + 
  scale_shape_manual(breaks = c(-0.9, 0, 0.9), values = -c(128937,43,9913)) +
