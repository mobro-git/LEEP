...
sens_dta = clean_data %>% filter(variable == "Emissions|CO2|Energy|Demand|Transportation",
                                 year %in% c(2030, 2035)) #%>% 
...
all_panels %>% write.csv(paste0("./output/final_figures/data/Transportation_sensitivity_data_",metric,".csv"))
```
