...
sens_dta = clean_data %>% filter(variable == "Emissions|CO2|Energy|Demand|Buildings",
                                 year %in% c(2030, 2035)) #%>% 
...
historic_emissions = (clean_data %>%
  filter(model == "EPA-GHGI",
         scenario == "Historic",
         variable == "Emissions|CO2|Energy|Demand|Buildings",
         year == 2005))$value
...
all_panels %>% write.csv(paste0("./output/final_figures/data/Buildings_sensitivity_data_",metric,".csv"))
```
