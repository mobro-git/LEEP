...
# clean_data = clean_data %>% mutate(value = case_when(
#     (model == "NEMS-OP-LTS" & scenario == "LTS.High" & year == 2025 & variable == "Emissions|CO2|Energy|Demand|Buildings") ~ (clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.High" & clean_data$year == 2020 & clean_data$variable == "Emissions|CO2|Energy|Demand|Buildings"),"value"]$value + clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.High" & clean_data$year == 2030 & clean_data$variable == "Emissions|CO2|Energy|Demand|Buildings"),"value"]$value) / 2,
#     (model == "NEMS-OP-LTS" & scenario == "LTS.High" & year == 2025 & variable == "Emissions|CO2|Energy|Demand|Industry") ~ (clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.High" & clean_data$year == 2020 & clean_data$variable == "Emissions|CO2|Energy|Demand|Industry"),"value"]$value + clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.High" & clean_data$year == 2030 & clean_data$variable == "Emissions|CO2|Energy|Demand|Industry"),"value"]$value) / 2,
#     (model == "NEMS-OP-LTS" & scenario == "LTS.High" & year == 2025 & variable == "Emissions|CO2|Energy|Demand|Transportation") ~ (clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.High" & clean_data$year == 2020 & clean_data$variable == "Emissions|CO2|Energy|Demand|Transportation"),"value"]$value + clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.High" & clean_data$year == 2030 & clean_data$variable == "Emissions|CO2|Energy|Demand|Transportation"),"value"]$value) / 2,
#     
#     (model == "NEMS-OP-LTS" & scenario == "LTS.Low" & year == 2025 & variable == "Emissions|CO2|Energy|Demand|Buildings") ~ (clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.Low" & clean_data$year == 2020 & clean_data$variable == "Emissions|CO2|Energy|Demand|Buildings"),"value"]$value + clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.Low" & clean_data$year == 2030 & clean_data$variable == "Emissions|CO2|Energy|Demand|Buildings"),"value"]$value) / 2,
#     (model == "NEMS-OP-LTS" & scenario == "LTS.Low" & year == 2025 & variable == "Emissions|CO2|Energy|Demand|Industry") ~ (clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.Low" & clean_data$year == 2020 & clean_data$variable == "Emissions|CO2|Energy|Demand|Industry"),"value"]$value + clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.Low" & clean_data$year == 2030 & clean_data$variable == "Emissions|CO2|Energy|Demand|Industry"),"value"]$value) / 2,
#     (model == "NEMS-OP-LTS" & scenario == "LTS.Low" & year == 2025 & variable == "Emissions|CO2|Energy|Demand|Transportation") ~ (clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.Low" & clean_data$year == 2020 & clean_data$variable == "Emissions|CO2|Energy|Demand|Transportation"),"value"]$value + clean_data[(clean_data$model == "NEMS-OP-LTS" & clean_data$scenario == "LTS.Low" & clean_data$year == 2030 & clean_data$variable == "Emissions|CO2|Energy|Demand|Transportation"),"value"]$value) / 2,
#   TRUE ~ value
# ))

cap_add_avg = clean_data %>% 
  filter(model %in% c("USREP-ReEDS", "GCAM-PNNL", "NEMS-OP"), 
...
p
ggsave(filename = "output/sw_figures/svg/Fig6.4_LTS_cone_buildings_facet.svg",p, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig6.4_LTS_cone_buildings_facet.png",p, width = 7, height = 5, units = "in")
...
p3 = lts_coneplot_with_dots(config, clean_data, figmap_leep_cone, 11, 12, "United States", 0, 30, title = "Transportation Sector Final Energy" , "median", facet = TRUE) +
  ...
  theme(plot.title = element_blank())
p3
ggsave(filename = "output/sw_figures/svg/Fig6.3_LTS_cone_transport_facet.svg",p3, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig6.3_LTS_cone_transport_facet.png",p3, width = 7, height = 5, units = "in")
...
p4 = lts_coneplot_with_dots(config, clean_data, figmap_leep_cone, 13, 14, "United States", 0, 23, title = "Industrial Sector Final Energy", "median", facet = TRUE) +
  ...
  theme(plot.title = element_blank())
p4
ggsave(filename = "output/sw_figures/svg/Fig6.5_LTS_cone_industry_facet.svg", p4, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig6.5_LTS_cone_industry_facet.png", p4, width = 7, height = 5, units = "in")
...
dta = rbind(dta1, dta2)
dta %>% write.csv("output/sw_figures/data/Fig6.4_LTS_cone_buildings_facet.csv", row.names = FALSE)
...
dta = rbind(dta1, dta2)
dta %>% write.csv("output/sw_figures/data/Fig6.3_LTS_cone_transport_facet.csv", row.names = FALSE)
...
dta = rbind(dta1, dta2)
dta %>% write.csv("output/sw_figures/data/Fig6.5_LTS_cone_industry_facet.csv", row.names = FALSE)
...
leep_models = c("USREP-ReEDS", "EPS-EI", "GCAM-CGS", "GCAM-PNNL", "GCAM-USA", "Haiku-RFF", "IPM-NRDC",
                "IPM-EPA", "MARKAL-NETL", "NEMS-RHG", "NEMS-RHG", "NEMS-OP", "REGEN-EPRI", "RIO-REPEAT",
                "ReEDS-NREL", "Scout-LEEP", "EIA-LTS", "EIA-STEO", "EPA-ATR")
...
ggsave(filename = "output/sw_figures/svg/Fig6.2NEW_LTS_cone_indirect_emissions_TOTAL.svg", 
       combined, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig6.2NEW_LTS_cone_indirect_emissions_TOTAL.png", 
       combined, width = 7, height = 5, units = "in")
...
dta %>% write.csv("output/sw_figures/data/Fig6.2NEW_LTS_cone_indirect_emissions_TOTAL.csv", row.names = FALSE)
...
# clean_data4 = rbind(raw, atr_2022) %>% filter(unit != "thousands") %>% mutate(value = 100 * value) %>%
...
# p = dot_plots("time_series", config, clean_data4, figmap_leep_timeseries, 118, "United States", 0, 100, "EV Share", metric = "median", hist_year = 2022, historic_coord = c(2015,8), preira_coord = c(2030, 16), ira_coord = c(2027, 45))
# print(p$full)
# print(p$stats)
# 
# 
# ggsave(filename = "output/sw_figures/svg/Fig3.4_ev_share.svg",p$full, width = 7, height = 5, units = "in")
# ggsave(filename = "output/sw_figures/png/Fig3.4_ev_share.png",p$full, width = 7, height = 5, units = "in")
# 
# # supporting data
# dta = data_from_graph("time_series", config, clean_data4, figmap_leep_cone, 118, "United States")
# dta %>% write.csv("output/sw_figures/data/Fig3.4_ev_share.csv", row.names = FALSE)
```
...
# atr_2022 = clean_data %>% filter(model == "EPA-ATR", year == 2021) %>% mutate(year = 2022)
# clean_data3 = rbind(clean_data, iea_2022)
# clean_data3 = clean_data3 %>% filter(model != "EIA-LTS") %>% 
#   duplicate_historical_data("EPA-ATR",2022) %>% 
...
ggsave(filename = "output/sw_figures/svg/Fig3.2_trans_co2.svg",fig, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig3.2_trans_co2.png",fig, width = 7, height = 5, units = "in")

# supporting data
dta = data_from_graph("stacked_bar", config, clean_data, figmap_leep_stackbar, 3, "United States")
dta %>% write.csv("output/sw_figures/data/Fig3.2_trans_co2.csv", row.names = FALSE)
```
...
ggsave(filename = "output/sw_figures/svg/Fig2.4_capacity.svg",combined, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig2.4_capacity.png",combined, width = 7, height = 5, units = "in")
print(stats)

#suporting data for plot
dta = data_from_graph("stacked_bar", config, clean_data, figmap_leep_stackbar, 4, "United States")
dta %>% write.csv("output/sw_figures/data/Fig2.4_capacity_bars.csv", row.names = FALSE)
dta4 %>% write.csv("output/sw_figures/data/Fig2.4_capacity_dots.csv", row.names = FALSE)
...
print(p1$full)
ggsave(filename = "output/sw_figures/svg/Fig5.3_industrial_energy_fossil.svg",p1$full, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig5.3_industrial_energy_fossil.png",p1$full, width = 7, height = 5, units = "in")
print(p1$stats)
...
dta %>% write.csv("output/sw_figures/data/Fig5.3_industrial_energy_fossil.csv", row.names = FALSE)
...
ggsave(filename = "output/sw_figures/svg/Fig2.6_nox.svg",nox_full$full, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig2.6_nox.png",nox_full$full, width = 7, height = 5, units = "in")
...
ggsave(filename = "output/sw_figures/svg/Fig2.7_sox.svg",sox_full$full, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig2.7_sox.png",sox_full$full, width = 7, height = 5, units = "in")
...
dta1 %>% write.csv("output/sw_figures/data/Fig2.6_nox.csv", row.names = FALSE)
dta2 %>% write.csv("output/sw_figures/data/Fig2.7_sox.csv", row.names = FALSE)
...
p1
ggsave(filename = "output/sw_figures/svg/Fig1.1_emis.svg",p1, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig1.1_emis.png",p1, width = 7, height = 5, units = "in")
...
p2
ggsave(filename = "output/sw_figures/svg/Fig3.1_emis_trans.svg",p2, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig3.1_emis_trans.png",p2, width = 7, height = 5, units = "in")
...
p3
ggsave(filename = "output/sw_figures/svg/Fig4.1_emis_build.svg",p3, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig4.1_emis_build.png",p3, width = 7, height = 5, units = "in")
...
p4
ggsave(filename = "output/sw_figures/svg/Fig5.1_emis_ind.svg",p4, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig5.1_emis_ind.png",p4, width = 7, height = 5, units = "in")
...
dta1 %>% write.csv("output/sw_figures/data/Fig1.1_emis.csv", row.names = FALSE)
...
ggsave(filename = "output/sw_figures/svg/Fig2.5_elec_sensitivity_dots.svg",combined, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig2.5_elec_sensitivity_dots.png",combined, width = 7, height = 5, units = "in")

# supporting data for figure
dta = bind_rows(sens_dta_panel1, sens_dta_panel3, sens_dta_panel4, sens_dta_panel5)
dta %>% write.csv("output/sw_figures/data/Fig2.5_elec_sensitivity_dots.csv", row.names = FALSE)
...
panel1_scens = c("Core","IRA", "IRA.Low","IRA.High")
panel2_scens = c("Low Growth", "High Growth", "Core", "IRA") # panel2_scens from fig 2.5, but "IRA" added for GCAM
...
p7 = sens_dot_plot(sens_dta_econ, title = "IRA Implementation", ymin = 0, ymax = 5000, far_left = TRUE, single = FALSE, 
...
p7b = sens_dot_plot(sens_dta_econ_panel2, title = "Economic Growth", ymin = 0, ymax = 5000)
p7b$plot

combined = (p7$plot | p7b$plot) +
...
ggsave(filename = "output/sw_figures/svg/Fig1.4_econwide_sensitivity_dots.svg",combined, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig1.4_econwide_sensitivity_dots.png",combined, width = 7, height = 5, units = "in")
...
sens_dta_econ_rpt = bind_rows(sens_dta_econ, sens_dta_econ_panel2)
sens_dta_econ_rpt %>% write.csv("output/sw_figures/data/Fig1.4_econwide_sensitivity_dots.csv", row.names = FALSE)


```


## Figure 2.2 - Historic Generation by Fuel Type
```{r}
...
fig = print_graph("stacked_bar", config, clean_data10, figmap_leep_stackbar, 14, "United States", 
                  level_var = c("Other", "Renewables", "Nuclear", "Natural Gas", "Coal")) +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5), plot.title = element_blank()) +
  bottom1
...
ggsave(filename = "output/sw_figures/svg/Fig2.2_hist_generation_mix.svg",fig, width = 7, height = 5, units = "in")
ggsave(filename = "output/sw_figures/png/Fig2.2_hist_generation_mix.png",fig, width = 7, height = 5, units = "in")

# supporting data
dta = data_from_graph("stacked_bar", config, clean_data10, figmap_leep_stackbar, 14, "United States")
dta %>% write.csv("output/sw_figures/data/Fig2.2_hist_generation_mix.csv", row.names = FALSE)
```
...
p = dot_plots_but_with_arrows("time_series", config, clean_data7, figmap_leep_timeseries, 123, "United States", 
                             0, 5, "Power Sector SO2 Emissions", metric = "median",
                             historic_coord = c(2017,2), preira_coord = c(2030, 1.2), ira_coord = c(2029, 0.12) )

# p = dot_plots_but_with_arrows("time_series", config, clean_data4, figmap_leep_timeseries, 118, "United States",
...
# Figure 2.6: nox
pct_diff_graph = function(plot_type, config, raw_data, figmap, fignum, region, exclude_models = c()) {
  raw_data = raw_data %>% filter(!model %in% exclude_models) %>%
    filter(year >= 2025) %>%
    mutate(alpha = case_when(
      model == "USREP-ReEDS" ~ 1,
      model == "GCAM-PNNL" ~ 1,
  ...
  data_copy = raw_data %>% filter(year == 2025) %>%
    mutate(value = 0, year = 2021)
  
  raw_data = rbind(raw_data, data_copy)
  
  medians = data_from_graph(plot_type, config, raw_data, figmap, fignum, region) %>% 
    filter(year %in% c(2030, 2035)) %>% 
    filter(value != 0) %>%
    group_by(year) %>% summarize(median = median(value)) %>%
    mutate(text = paste0(round(median,1),"%"))
  
  p = print_graph(plot_type, config, raw_data, figmap, fignum, region) +
    geom_point(data = medians, aes(x = year, y = median), color = "black", type = 16, size = 2) +
    geom_text(data = medians, aes(x = year, y = median, label = text), 
              color = "black", size = 3, hjust = 1.2, vjust = -0.2) + 
    scale_alpha(range = c(0.6, 1), guide = "none") + 
...
# p1
# ggsave(filename = "output/sw_figures/svg/Pct_diff/Fig2.6_pctdiff.svg",p1, width = 7, height = 5, units = "in")
# ggsave(filename = "output/sw_figures/png/Pct_diff/Fig2.6_pctdiff.png",p1, width = 7, height = 5, units = "in")
# 
# 
# # Figure 2.7: Sox
# p2 = pct_diff_graph("time_series", config, clean_data, figmap_leep_timeseries, 126, "United States")
# p2
# ggsave(filename = "output/sw_figures/svg/Pct_diff/Fig2.7_pctdiff.svg",p2, width = 7, height = 5, units = "in")
# ggsave(filename = "output/sw_figures/png/Pct_diff/Fig2.7_pctdiff.png",p2, width = 7, height = 5, units = "in")
# 
# 
...
# p3
# ggsave(filename = "output/sw_figures/svg/Pct_diff/Fig5.3_pctdiff.svg",p3, width = 7, height = 5, units = "in")
# ggsave(filename = "output/sw_figures/png/Pct_diff/Fig5.3_pctdiff.png",p3, width = 7, height = 5, units = "in")
...
```{r}
# compile data
test = compile_all_data()

```
## ARCHIVE: old capacity addition
```{r}
fig_no = 2.5
...
fig = print_graph("stacked_bar", config, clean_data, figmap_leep_stackbar, 4, "United States") +
  ...
  ggtitle("Historical Annual Capacity Changes") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5, size = 10),
        axis.text.x = element_text(angle = 45), axis.ticks = element_blank())
