...
```{r}
# uncertainty plot
clean_data2 = clean_data %>% duplicate_historical_data("EIA-STEO",2020) %>% mutate(alpha = 1)
...
print(p1$full)
ggsave(filename = "output/leep/time_series/Fig21_industrial_energy_fossil.svg",p1$full, width = 7, height = 5, units = "in")
print(p1$stats)
...
print(p2$full)
ggsave(filename = "output/leep/time_series/Fig23_industrial_energy_elec.svg",p2$full, width = 7, height = 5, units = "in")
print(p2$stats)
...
print(p3$full)
ggsave(filename = "output/leep/time_series/Fig22_industrial_energy_alternative.svg",p3$full, width = 7, height = 5, units = "in")
print(p3$stats)
