...
dta = rbind(dta1, dta2)
dta %>% write.csv("output/final_figures/data/Fig6.4_LTS_cone_buildings_facet.csv", row.names = FALSE)
...
ggsave(filename = "output/final_figures/svg/Fig6.2NEW_LTS_cone_indirect_emissions_TOTAL.svg", 
       combined, width = 7, height = 5, units = "in")
ggsave(filename = "output/final_figures/png/Fig6.2NEW_LTS_cone_indirect_emissions_TOTAL.png", 
       combined, width = 7, height = 5, units = "in")
...
dta %>% write.csv("output/final_figures/data/Fig6.2NEW_LTS_cone_indirect_emissions_TOTAL.csv", row.names = FALSE)
...
# 
# 
# ggsave(filename = "output/final_figures/svg/Fig3.4_ev_share.svg",p$full, width = 7, height = 5, units = "in")
# ggsave(filename = "output/final_figures/png/Fig3.4_ev_share.png",p$full, width = 7, height = 5, units = "in")
# 
# # supporting data
# dta = data_from_graph("time_series", config, clean_data4, figmap_leep_cone, 118, "United States")
# dta %>% write.csv("output/final_figures/data/Fig3.4_ev_share.csv", row.names = FALSE)
```
...
ggsave(filename = "output/final_figures/svg/Fig3.2_trans_co2.svg",fig, width = 7, height = 5, units = "in")
ggsave(filename = "output/final_figures/png/Fig3.2_trans_co2.png",fig, width = 7, height = 5, units = "in")

# supporting data
dta = data_from_graph("stacked_bar", config, clean_data, figmap_leep_stackbar, 3, "United States")
dta %>% write.csv("output/final_figures/data/Fig3.2_trans_co2.csv", row.names = FALSE)
```
...
ggsave(filename = "output/final_figures/svg/Fig2.6_nox.svg",nox_full$full, width = 7, height = 5, units = "in")
ggsave(filename = "output/final_figures/png/Fig2.6_nox.png",nox_full$full, width = 7, height = 5, units = "in")
...
ggsave(filename = "output/final_figures/svg/Fig2.7_sox.svg",sox_full$full, width = 7, height = 5, units = "in")
ggsave(filename = "output/final_figures/png/Fig2.7_sox.png",sox_full$full, width = 7, height = 5, units = "in")
...
dta1 %>% write.csv("output/final_figures/data/Fig2.6_nox.csv", row.names = FALSE)
dta2 %>% write.csv("output/final_figures/data/Fig2.7_sox.csv", row.names = FALSE)
...
p1
ggsave(filename = "output/final_figures/svg/Fig1.1_emis.svg",p1, width = 7, height = 5, units = "in")
ggsave(filename = "output/final_figures/png/Fig1.1_emis.png",p1, width = 7, height = 5, units = "in")
...
p2
ggsave(filename = "output/final_figures/svg/Fig3.1_emis_trans.svg",p2, width = 7, height = 5, units = "in")
ggsave(filename = "output/final_figures/png/Fig3.1_emis_trans.png",p2, width = 7, height = 5, units = "in")
...
p3
ggsave(filename = "output/final_figures/svg/Fig4.1_emis_build.svg",p3, width = 7, height = 5, units = "in")
ggsave(filename = "output/final_figures/png/Fig4.1_emis_build.png",p3, width = 7, height = 5, units = "in")
...
dta1 %>% write.csv("output/final_figures/data/Fig1.1_emis.csv", row.names = FALSE)
...
ggsave(filename = "output/final_figures/svg/Fig1.4_econwide_sensitivity_dots.svg",combined, width = 7, height = 5, units = "in")
ggsave(filename = "output/final_figures/png/Fig1.4_econwide_sensitivity_dots.png",combined, width = 7, height = 5, units = "in")
...
sens_dta_econ_rpt %>% write.csv("output/final_figures/data/Fig1.4_econwide_sensitivity_dots.csv", row.names = FALSE)
...
# p1
# ggsave(filename = "output/final_figures/svg/Pct_diff/Fig2.6_pctdiff.svg",p1, width = 7, height = 5, units = "in")
# ggsave(filename = "output/final_figures/png/Pct_diff/Fig2.6_pctdiff.png",p1, width = 7, height = 5, units = "in")
# 
# 
# # Figure 2.7: Sox
# p2 = pct_diff_graph("time_series", config, clean_data, figmap_leep_timeseries, 126, "United States")
# p2
# ggsave(filename = "output/final_figures/svg/Pct_diff/Fig2.7_pctdiff.svg",p2, width = 7, height = 5, units = "in")
# ggsave(filename = "output/final_figures/png/Pct_diff/Fig2.7_pctdiff.png",p2, width = 7, height = 5, units = "in")
# 
# 
...
# p3
# ggsave(filename = "output/final_figures/svg/Pct_diff/Fig5.3_pctdiff.svg",p3, width = 7, height = 5, units = "in")
# ggsave(filename = "output/final_figures/png/Pct_diff/Fig5.3_pctdiff.png",p3, width = 7, height = 5, units = "in")
