...
```{r}
fig1 = print_graph("cone_uncertainty", config, clean_data, figmap_leep_cone, 1, "United States") +
  scale_y_continuous(limits = c(0, 20))
fig1

fig2 = print_graph("cone_uncertainty", config, clean_data, figmap_leep_cone, 2, "United States") +
  scale_y_continuous(limits = c(0, 20))
fig2
...
fig3
df3 = data_from_graph("cone_uncertainty", config, clean_data, figmap_leep_cone, 3, "United States")

fig4 = print_graph("cone_uncertainty", config, clean_data, figmap_leep_cone, 4, "United States") +
  scale_y_continuous(limits = c(0, 2500))
fig4
df4 = data_from_graph("cone_uncertainty", config, clean_data, figmap_leep_cone, 4, "United States")
...
fig6 = print_graph("cone_uncertainty", config, clean_data, figmap_leep_cone, 6, "United States") +
  scale_y_continuous(limits = c(0, 30))
fig6
...
fig8 = print_graph("cone_uncertainty", config, clean_data, figmap_leep_cone, 8, "United States") +
  scale_y_continuous(limits = c(0, 12))
fig8
