...
ggsave(filename = "output/leep/cone_uncertainty/Fig6.2NEW_LTS_cone_indirect_emissions_TOTAL.png", combined, width = 7, height = 5, units = "in")
...
emis_stack = function(dta, title, econwide = FALSE) {
  ...
  if (econwide) {
    ...
    bar_code = geom_bar(aes(x = year, y = value, fill = variable_rename, 
                            color = variable_rename, alpha = variable_rename), position = position_stack(), stat = "identity")
  }
...
p2 = emis_stack(dta2, "Transportation CO2 Emissions") + 
  ...
  scale_color_manual(values = c("Other Sectors" = "black", "Transportation: Indirect" = subpalettes$`Emissions Stack`[["Transportation: Indirect"]], "Transportation: Direct" = subpalettes$`Emissions Stack`[["Transportation: Direct"]])) +
...
p3 = emis_stack(dta3, "Buildings CO2 Emissions") + 
  ...
  scale_color_manual(values = c("Other Sectors" = "black", "Buildings: Indirect" = subpalettes$`Emissions Stack`[["Buildings: Indirect"]], "Buildings: Direct" = subpalettes$`Emissions Stack`[["Buildings: Direct"]])) +
...
p4 = emis_stack(dta4, "Industrial CO2 Emissions") + 
  ...
  scale_color_manual(values = c("Other Sectors" = "black", "Industry: Indirect" = subpalettes$`Emissions Stack`[["Industry: Indirect"]], "Industry: Direct" = subpalettes$`Emissions Stack`[["Industry: Direct"]])) +
