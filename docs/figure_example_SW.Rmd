...
```{r}
  ...
  p
  ggsave(filename = "output/leep/cone_uncertainty/LTS_cone_buildings.svg",p, width = 7, height = 5, units = "in")
  ...
  p3
  ggsave(filename = "output/leep/cone_uncertainty/LTS_cone_transport.svg",p3, width = 7, height = 5, units = "in")
  p4 = lts_coneplot_with_dots(config, clean_data, figmap_leep_cone, 7, 8, "United States", 0, 25, "mean", facet = FALSE)
  p4
  ggsave(filename = "output/leep/cone_uncertainty/LTS_cone_industry.svg",p4, width = 7, height = 5, units = "in")
  p5 = lts_coneplot_with_dots(config, clean_data, figmap_leep_cone, 9, 10, "United States", -1000, 2500, "mean", facet = TRUE)
  p5
  ggsave(filename = "output/leep/cone_uncertainty/LTS_cone_emissions_new.svg",p5, width = 7, height = 5, units = "in")
```
...
fig
ggsave(filename = "output/leep/time_series/emis_sensitivity.svg",fig, width = 7, height = 5, units = "in")
```
