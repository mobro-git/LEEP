...
fig = print_graph("time_series", config, clean_data4, figmap_leep_timeseries, 18, "United States") +
  ...
  annotate("text", x = 2015, y = 59, label = "Historic", color = "black") +
  annotate("text", x = 2027, y = 55, label = "Pre-IRA", color = "#0388B3") +
  annotate("text", x = 2025, y = 20, label = "IRA", color = "#F28063")
