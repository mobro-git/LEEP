...
panel1_scens = c("IRA","IRA.Low","IRA.High")
panel2_scens = c() # Economic Growth
panel3_scens = c("IRA.LGP","IRA.HGP") # Energy Prices
panel4_scens = c("IRA.AllClean", "IRA.AdvBRE", "IRA.ConsBRE") # Technology Cost
panel5_scens = c("IRA.Cons") # Deployment Constraints
...
sens_dot_plot = function(dta, far_left = FALSE, ira_coord = c(0,0), low_coord = c(0,0), high_coord = c(0,0)) {
  if (far_left) {
  ...
  if (!far_left) {
    ...
    p = p +
      ...
      scale_color_manual(values = c("IRA" = "black", "IRA.Low" = "#42d4f4", "IRA.High" = "#f58231"), guide = "none") +
      annotate("text", x = ira_coord[1], y = ira_coord[2], size = 2.5,
               label = "IRA", color = "black", alpha = 1, hjust = -0.2) +
      annotate("text", x = low_coord[1], y = low_coord[2], size = 2.5,
               label = "IRA.Low", color = "#42d4f4", alpha = 1, hjust = -0.2) +
      annotate("text", x = high_coord[1], y = high_coord[2], size = 2.5,
               label = "IRA.High", color = "#f58231", alpha = 1, hjust = -0.2)
...
p1 = sens_dot_plot(sens_dta_panel1, far_left = TRUE, ira_coord = c(2030,1275), low_coord = c(2030, 1425), 
                   high_coord = c(2030, 250))
#p1
p2 = sens_dot_plot(sens_dta_panel2)
#p2
p3 = sens_dot_plot(sens_dta_panel3)
# p3
p4 = sens_dot_plot(sens_dta_panel4)
# p4
p5 = sens_dot_plot(sens_dta_panel5)
# p5
...
ggsave(filename = "output/leep/dots/Fig1.4_elec_sensitivity_dots.svg",combined, width = 7, height = 5, units = "in")
