...
indicators_all = bind_rows(indicators_elec,
                           indicators_tran,
                           indicators_buil,
                           indicators_ind,
                           indicators_econ
...
indicators_all_baseline = bind_rows(indicators_elec_baseline,
                                    indicators_tran_baseline,
                                    indicators_buil_baseline,
                                    indicators_ind_baseline,
                                    indicators_econ_baseline
                           )
...
```{r}
clean_data1 = filter_sensitivities(clean_data)
