...
write.xlsx(summary, "output/pre-brief/summary_range_table_all_sensitivities.xlsx")
```
...
EconDot = dotted_msb(clean, EconSpg$figure, "median", 0, 7000, config, figmap_leep_timeseries)
EconDot

# saveall(EconDot, EconSpg$data, fig_no)

delta = delta_msb(1000, c("IPM-NRDC", "IPM-EPA", "ReEDS-NREL", "Scout-LEEP", "Haiku-RFF"), config, clean_data, figmap_leep_timeseries)
delta
